  ...
  return (
    <main className="min-h-screen bg-background text-foreground flex items-center justify-center p-4">
      <div className="w-full max-w-md mx-auto flex flex-col items-center">
        ...
        {/* Not a Client Yet */}
        <div className="mt-8 text-center p-6 bg-card border border-border rounded-lg w-full">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-6 py-2 bg-red-500 hover:bg-red-500 rounded-lg transition-colors text-foreground font-medium"
            >
              Contact Us
            </Link>
          </div>
