    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gray-900 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-black p-8 md:p-10 rounded-xl border border-gray-800">
            <div className="w-16 h-16 bg-red-600/20 rounded-full flex items-center justify-center mb-6">
              <Database className="w-8 h-8 text-red-500" />
            </div>
            <h3 className="text-white mb-4 text-2xl">We Build Custom Systems</h3>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-300">Track all customer or patient information</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-red-600 rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-gray-300">See the status of tasks and appointments</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-red-600 rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-gray-300">Store and organize all your documents</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-red-600 rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-gray-300">Built specifically for how your business works</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-black p-8 md:p-10 rounded-xl border border-gray-800">
            ...
            <h3 className="text-white mb-4 text-2xl">We Connect to What You Have</h3>
            <p className="text-gray-300 text-lg leading-relaxed mb-6">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-red-600 rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-gray-300">Works with your current software</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-red-600 rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-gray-300">No disruption to your daily operations</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-red-600 rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-gray-300">Sync data automatically between systems</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-red-600 rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-gray-300">Connects even with older, legacy programs</p>
              </div>
            </div>
          </div>
        </div>
        
        <div className="mt-10 bg-black p-8 rounded-xl border border-gray-800 text-center">
          <p className="text-gray-300 text-lg leading-relaxed max-w-3xl mx-auto">
            <span className="text-white">Bottom line:</span> Whether we build you a new system or connect to what you're using now, 
