      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-black p-8 rounded-xl border border-gray-800 text-center">
            ...
            <h3 className="text-white mb-4 text-2xl">Save Time</h3>
          ...
          <div className="bg-black p-8 rounded-xl border border-gray-800 text-center">
            ...
            <h3 className="text-white mb-4 text-2xl">Fewer Mistakes</h3>
            <p className="text-gray-300 text-lg leading-relaxed">
          ...
          <div className="bg-black p-8 rounded-xl border border-gray-800 text-center">
            ...
            <h3 className="text-white mb-4 text-2xl">Always Working</h3>
            <p className="text-gray-300 text-lg leading-relaxed">
